...
bg = Entity(model='quad',texture='bg2.png',scale=45,position=(4,10,1),z=1)
camera.orthographic = True
camera.fov = 20
ground = Entity(model='cube',color=(67,30,67,45), z=-.1, y=-1, origin_y=.5, scale=(45,10,1), collider='box', ignore=True)
random.seed(4)
for i in range(5):
    Entity(model='cube',color=(240,244,244,0.4), collider='box', ignore=True, position=(random.randint(-10,20), random.randint(0,10) + i * 2), scale=(random.randint(1,20), random.randint(2,5), 10),z=i)
